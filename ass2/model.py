...
##        print("this is input embed",input_word_embeds)
##        print("this is word embed",self.char_embeds)
        input_char_embeds = self.char_embeds(batch_char_index_matrices)
##        print("this is char embd input",input_char_embeds)
        # employ char embedding if the flag is True
        if self.config.use_char_embedding:
...
##        print("thisis char cahr chart", input_embeds_chars)
##        print("this is input",input_embeds)
##        print("this is batch_char_index_matrices",batch_char_index_matrices)
##        print("this is batch_word_len_lists",batch_word_len_lists)
##        print("this is batch_sentence_len_list",batch_sentence_len_list)
##        a=get_char_sequence(self, batch_char_index_matrices, batch_word_len_lists)
##        print(a.ndimension(),a.size())
##        print("this is size",input_embeds.size(),input_embeds.ndimension())
        perm_idx, sorted_batch_sentence_len_list = self.sort_input(batch_sentence_len_list)
##        print("tis is per",perm_idx,batch_sentence_len_list)
##        print("ti is sorted_batch_sentence_len_list",sorted_batch_sentence_len_list)
